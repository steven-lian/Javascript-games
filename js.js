...
function displayMsg() {
  ...
  newimg.src = "images/smile face.jpg";
...
function displayProfile() {
      document.querySelector(
        "#displayCard"
                    ...
                    <img class="card-img-top" src="${profile.img}" style.height="100px" alt="Card image">
                    <div class="card-body">
